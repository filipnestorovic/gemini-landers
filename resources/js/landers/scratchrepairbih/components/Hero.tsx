...
export const Hero = () => {
  return (
    <section className="relative min-h-[90vh] md:min-h-screen flex items-center justify-center overflow-hidden bg-gray-900 pt-16 md:pt-28 pb-12 md:pb-24">
        ...
        <div className="max-w-4xl mx-auto md:mx-0 text-center md:text-left">
          ...
          <div className="mb-8 md:mb-12 reveal delay-200">
            <p className="text-xl md:text-3xl text-white font-bold mb-3 md:mb-5 leading-snug">
              Vaš automobil ponovo sija kao nov.
            </p>
            <p className="text-base md:text-xl text-gray-400 max-w-2xl leading-relaxed mx-auto md:mx-0">
              Specijalni sprej momentalno popunjava oštećenja na laku i stvara trajni zaštitni sloj. Rješenje koje štedi novac na skupim popravkama kod autolimara.
            </p>
          </div>
