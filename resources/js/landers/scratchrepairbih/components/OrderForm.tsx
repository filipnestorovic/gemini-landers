...
export const OrderForm: React.FC<OrderFormProps> = ({ onOrderSuccess }) => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      alert('Došlo je do greške. Molimo vas provjerite podatke.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="bg-white rounded-3xl p-6 md:p-8 text-gray-900 shadow-2xl border border-gray-100 relative">
      <div className="text-center mb-8">
        ...
        <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-1 tracking-tight">Potvrdi Narudžbu</h3>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {BUNDLES.map((bundle) => (
              ...
              >
                ...
                <div className="text-right">
                  <div className="font-black text-gray-900 text-lg">{bundle.price} KM</div>
                  {bundle.freeShipping && (
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-3">
            ...
            <input 
              type="tel" name="phone" placeholder="Broj telefona (npr. 06...)" required
              className="w-full p-4 bg-gray-50 border border-gray-200 rounded-xl outline-none text-base transition-all focus:ring-2 focus:ring-red-600 focus:ring-opacity-20 focus:border-red-600"
              onChange={handleInputChange}
        ...
        <div className="bg-gray-50 rounded-2xl p-5 border border-gray-100">
           ...
           <div className="flex justify-between items-center">
             ...
             <span className="text-3xl font-black text-red-600">{totalPrice} KM</span>
           </div>
        </div>
        ...
        <div className="pt-2">
          ...
          <div className="flex items-center justify-center gap-6 mt-6 text-[10px] text-gray-400 font-bold uppercase tracking-widest">
            <span className="flex items-center gap-1"><Lock size={12} /> SSL Sigurna</span>
            <span className="flex items-center gap-1"><Shield size={12} /> Garancija</span>
          </div>
        </div>
      </form>
    </div>
