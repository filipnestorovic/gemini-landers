...
const reviews = [
  {
    name: "Emir Hadžić",
    city: "Sarajevo",
    text: "Nisam vjerovao dok nisam probao. Imao sam ružnu ogrebotinu na vratima od parkinga. Nestala je za 2 minuta! Svaka čast.",
    rating: 5,
  ...
  },
  {
    name: "Siniša Vuković",
    city: "Banja Luka",
    text: "Dostava je bila stvarno brza, stiglo je za tri dana. Proizvod radi tačno ono što piše. Preporuka svima koji čuvaju auto.",
    rating: 5,
          ...
          >
            ...
            <div className="mt-4 pt-4 border-t border-gray-700 flex items-center gap-2">
              <span className="text-green-400 text-xs font-bold flex items-center gap-1 uppercase tracking-wider">
                <CheckCircle2 size={12} /> Provjerena kupovina
              </span>
            </div>
          </div>
        ))}
