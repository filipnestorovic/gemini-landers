    ...
    <footer className="bg-gray-950 text-gray-400 py-12 border-t border-gray-800">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="max-w-sm mb-4">
              Vodeći distributer opreme za njegu automobila u BiH.
              Naša misija je da vaš automobil uvijek izgleda kao nov, uz minimalan trošak.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3"><li className="flex items-center gap-2">
                <Mail size={18} className="text-red-600" />
                <span>info@homecarshop.com</span>
              </li>
              <li className="text-sm">
                Dostupni svakog dana 24/7
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} {PRODUCT_SETTINGS.storeName} BiH. Sva prava zadržana.</p>
        </div>
      </div>
    </footer>
  );
