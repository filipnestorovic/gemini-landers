...
const recentSales = [
  { name: 'Adnan K.', city: 'Sarajevo', product: 'Pro Paket', time: 'prije 2 min' },
  { name: 'Goran M.', city: 'Banja Luka', product: 'Start Paket', time: 'prije 5 min' },
  { name: 'Josip B.', city: 'Mostar', product: 'Mega Paket', time: 'prije 12 min' },
  { name: 'Tarik S.', city: 'Tuzla', product: 'Pro Paket', time: 'prije 1 min' },
  { name: 'Amra D.', city: 'Zenica', product: 'Pro Paket', time: 'prije 8 min' },
  { name: 'Darko R.', city: 'Bihać', product: 'Start Paket', time: 'prije 15 min' },
  { name: 'Lejla H.', city: 'Bijeljina', product: 'Mega Paket', time: 'prije 4 min' },
];
