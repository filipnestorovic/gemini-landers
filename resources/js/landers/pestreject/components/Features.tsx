        ...
        <div className="py-12 bg-white">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="lg:text-center mb-12">
                    <h2 className="text-base text-brand-green font-bold tracking-wide uppercase">REŠITE PROBLEM ZAUVEK</h2>
                    <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                        Zašto je Pest Reject jedino pravo rešenje?
                    </p>
                        ...
                        <div className="bg-white p-6 rounded-xl border-2 border-red-100 shadow-sm">
                            ...
                            <ul className="space-y-4">
                                <li className="flex items-start text-gray-600">
                                    ...
                                    <span>Opasni otrovi koji mogu povrediti ljubimce</span>
                                </li>
                                <li className="flex items-start text-gray-600">
                                    <XCircle className="w-5 h-5 text-red-400 mr-2 flex-shrink-0 mt-0.5" />
                            ...
                            <div className="p-6">
                                ...
                                <ul className="space-y-4">
                                    <li className="flex items-start text-gray-800 font-medium">
                                        ...
                                        <span>Potpuno bezbedno za decu i ljubimce</span>
                                    </li>
                                    <li className="flex items-start text-gray-800 font-medium">
                                        <CheckCircle className="w-5 h-5 text-brand-green mr-2 flex-shrink-0 mt-0.5" />
                                        <span>Samo otera štetočine - nema leševa</span>
                                    </li>
                                    <li className="flex items-start text-gray-800 font-medium">
                                        <CheckCircle className="w-5 h-5 text-brand-green mr-2 flex-shrink-0 mt-0.5" />
