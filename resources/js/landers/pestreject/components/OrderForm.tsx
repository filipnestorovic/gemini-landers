...
const OrderForm: React.FC<OrderFormProps> = ({ selectedBundle, onBundleChange }) => {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            setErrorMsg('Došlo je do greške. Molimo vas proverite podatke ili pokušajte kasnije.');
        } finally {
            setLoading(false);
        }
    };
        ...
        return (
            <div id="order-form" className="bg-green-50 py-16 px-4">
                <div className="max-w-2xl mx-auto bg-white rounded-3xl p-8 shadow-xl text-center border border-green-100">
                    ...
                    <h3 className="text-3xl font-extrabold text-green-800 mb-2">Hvala na porudžbini!</h3>
                    <p className="text-gray-600 text-lg mb-4">Vaša porudžbina je uspešno primljena.</p>
                    <div className="bg-gray-50 p-4 rounded-xl inline-block border border-gray-100">
                        <p className="font-bold text-gray-800">Ukupno za plaćanje: {totalPrice} RSD</p>
        ...
        <div id="order-form" className="bg-gray-50 py-12 border-t border-gray-200">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-8">
                    <h2 className="text-3xl font-extrabold text-gray-900">Brza i sigurna porudžbina</h2>
                    ...
                    <form onSubmit={handleSubmit} className="p-6 md:p-10 space-y-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-brand-lightGreen p-5 rounded-2xl border border-brand-green/30">
                                <label className="block text-sm font-bold text-gray-800 mb-2">Promenite paket ako želite:</label>
                                    ...
                                    >
                                        {BUNDLES.map(b => (
                                            <option key={b.id} value={b.id}>
                                                {b.label} - {b.price} RSD {b.isPopular ? '(Najprodavanije)' : ''}
                                            </option>
                                        ))}
                                    </select>
                                ...
                                <div className="mt-4 flex items-center justify-between p-3 bg-white/60 rounded-lg">
                                    ...
                                    <div className="text-right">
                                        <span className="block text-xs text-gray-500">Cena paketa:</span>
                                        <span className="text-xl font-black text-brand-red">{selectedBundle.price} RSD</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-4">
                                ...
                                <input
                                    ...
                                    name="phone"
                                    required
                                    pattern="^((\+381)|(00381)|(0))[0-9]{8,10}$"
                                    title="Unesite validan broj telefona (npr. 0641234567 ili +38164...)"
                                    value={formState.phone}
                                    onChange={handleInputChange}
                                    className="w-full p-4 bg-gray-50 border border-gray-200 rounded-xl outline-none text-base transition-all focus:ring-2 focus:ring-brand-green focus:ring-opacity-20 focus:border-brand-green"
                                    placeholder="Broj telefona (npr. 0641234567)"
                                />
                        ...
                        <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100 mt-6">
                            ...
                            <div className="flex justify-between items-center mb-6">
                                ...
                                <span className="text-3xl font-black text-brand-red">{totalPrice} RSD</span>
                            </div>
