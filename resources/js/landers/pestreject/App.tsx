        ...
        <div className="min-h-screen flex flex-col font-sans">
            ...
            <div className="bg-brand-dark py-12 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
                    ...
                    <p className="text-brand-lightGreen max-w-2xl mx-auto text-lg">Svaki dan čekanja povećava rizik od bolesti i oštećenja imovine. Rešite problem odmah uz <span className="font-bold text-white">40% popusta.</span></p>
                </div>
            </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                        <div>
                            ...
                            <p className="text-gray-400 text-sm">Vaš partner za bezbedan i čist dom bez štetočina. Hiljade zadovoljnih korisnika širom Srbije.</p>
                        </div>
                        <div>
                            ...
                            <ul className="space-y-2 text-sm text-gray-400">
                                ...
                                <li><button onClick={() => scrollToSection('order-form')} className="hover:text-white">Poručivanje</button></li>
                            </ul>
                        </div>
                        <div id="contact">
            ...
            <div className="fixed bottom-0 left-0 right-0 p-3 bg-white border-t border-gray-200 lg:hidden z-50 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.2)]">
                ...
                >
                    NARUČI - {selectedBundle.price} RSD
                </button>
            </div>
