    ...
    <footer className="bg-slate-950 text-slate-400 py-12 border-t border-slate-800">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#features" className="hover:text-brand-red transition">O Proizvodu</a></li>
              <li><a href="#order" className="hover:text-brand-red transition">Naruči</a></li>
              {/*<li><a href="#" className="hover:text-brand-red transition">Uslovi kupovine</a></li>*/}
              {/*<li><a href="#" className="hover:text-brand-red transition">Politika privatnosti</a></li>*/}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2">
                ...
                <span>info@homecarshop.com</span>
              </li>
        ...
        <div className="border-t border-slate-800 mt-12 pt-8 text-center text-sm">
          <p>&copy; {new Date().getFullYear()} {PRODUCT_SETTINGS.storeName} | Sva prava zadržana.</p>
        </div>
      </div>
    </footer>
  );
