...
export const Hero = () => {
    return (
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#0F172A] pt-20">
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[#0F172A] to-[#0F172A] z-[1]"></div>

            <div className="container relative z-10 py-12 md:py-24 text-center md:text-left">
                <div className="max-w-4xl mx-auto md:mx-0">
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-red-600/10 border border-red-600/30 rounded-full text-red-500 text-xs md:text-sm font-bold mb-6 uppercase tracking-widest reveal">
                        <Award size={16} />
                        <span>Broj 1 u Srbiji • Hiljade zadovoljnih kupaca</span>
                    </div>

                    <h1 className="text-[2.5rem] leading-[1.1] md:text-7xl font-extrabold text-white mb-8 reveal delay-100 font-display">
                        UKLONITE <br className="hidden md:block" />
                        <span className="text-brand-red">OGREBOTINE</span> <br className="hidden md:block" />
                        ZA 10 SEKUNDI
                    </h1>

                    <p className="text-lg md:text-2xl text-slate-300 mb-10 max-w-2xl leading-relaxed reveal delay-200">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-6 reveal delay-400">
                        <a
                            href="#order"
                            className="w-full sm:w-auto px-10 py-5 bg-brand-red text-white text-xl font-bold rounded-2xl transition btn-glow flex items-center justify-center gap-3 group"
                        >
                            NARUČI ODMAH <ChevronRight size={24} className="group-hover:translate-x-1 transition-transform" />
                        </a>
                        <div className="flex items-center gap-2 text-slate-400 font-bold text-sm">
                            <Clock size={20} className="text-brand-red animate-pulse" />
