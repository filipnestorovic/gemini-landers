    ...
    <div className="py-16 bg-brand-lightGreen/30 border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-base text-brand-green font-bold tracking-wide uppercase">JEDNOSTAVNO KORIŠTENJE</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          ...
          <div className="relative p-6 bg-white rounded-xl shadow-md border border-gray-100">
            ...
            <p className="text-gray-600">
              Plavo svjetlo označava da ultrazvučni talasi počinju da se šire kroz zidove i prostor.
            </p>
          </div>
          ...
          <div className="relative p-6 bg-white rounded-xl shadow-md border border-gray-100">
            ...
            <p className="text-gray-600">
              Štetočine osjećaju nelagodnost i napuštaju vaš dom zauvijek u roku od 2-3 sedmice.
            </p>
          </div>
        </div>
      </div>
